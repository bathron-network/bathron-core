 ...
 * thread wrappers
 */
#ifndef BATHRON_UTIL_SYSTEM_H
#define BATHRON_UTIL_SYSTEM_H
...
extern const char * const BATHRON_CONF_FILENAME;
extern const char * const BATHRON_PID_FILENAME;
