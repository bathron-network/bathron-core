/* src/config/bathron-config.h.  Generated from bathron-config.h.in by configure.  */
/* src/config/bathron-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BATHRON_CONFIG_H

#define BATHRON_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/AdonisPhusis/BATHRON/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BATHRON"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BATHRON 0.9.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bathron"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://github.com/AdonisPhusis/BATHRON"
