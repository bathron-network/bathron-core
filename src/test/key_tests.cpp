...
static const std::string strSecret1  = "69EPhp76RwVyvWSK5tMZAz8FQdMzFsdVCUhDpFidhYcVyEtcdkV";
static const std::string strSecret2  = "68ZM8amLPyYBiDvT38TBmnURc4mHiUuKxwS9UhrGt3jUwnSNmKc";
static const std::string strSecret1C = "PhL7D8uty5YvFAvipZfj158zbHVdieU3TfEXZZxkyxXgs21j8CF2";
static const std::string strSecret2C = "PeMmrU2gcQYeGx2uvPtaYfi3bmcUn69xhuFzRHJV6K4WLX7gHmJ6";
static const std::string addr1 = "BAZhCyfnTxJF7EyKo4GRc9mbzufy1nV264";
static const std::string addr2 = "BPEJkNWowummtPensZFKGJJd1JhqCFR516";
static const std::string addr1C = "BMhqMmfDSFr6Q5Fp6itWobf2NJ7ADpDh3s";
static const std::string addr2C = "BMVUWdKAV3P1AZs43TMDyyATADics9Nuk8";
