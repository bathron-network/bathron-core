...
// Copyright (c) 2020-2022 The BATHRON Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet_sapling_validateaddress)
{
    ...
    BOOST_CHECK_NO_THROW(retValue = CallRPC("validateaddress bs1u87kylcmn28yclnx2uy0psnvuhs2xn608ukm6n2nshrpg2nzyu3n62ls8j77m9cgp40dx4m2hks"));
...
BOOST_AUTO_TEST_CASE(rpc_wallet_getbalance)
{
    ...
    BOOST_CHECK_NO_THROW(CallRPC("getshieldbalance bs1u87kylcmn28yclnx2uy0psnvuhs2xn608ukm6n2nshrpg2nzyu3n62ls8j77m9cgp40dx4m2hks"));
    BOOST_CHECK_THROW(CallRPC("getshieldbalance bs1u87kylcmn28yclnx2uy0psnvuhs2xn608ukm6n2nshrpg2nzyu3n62ls8j77m9cgp40dx4m2hks -1"), std::runtime_error);
    BOOST_CHECK_NO_THROW(CallRPC("getshieldbalance bs1u87kylcmn28yclnx2uy0psnvuhs2xn608ukm6n2nshrpg2nzyu3n62ls8j77m9cgp40dx4m2hks 0"));
    ...
    BOOST_CHECK_THROW(CallRPC("listreceivedbyshieldaddress bs1u87kylcmn28yclnx2uy0psnvuhs2xn608ukm6n2nshrpg2nzyu3n62ls8j77m9cgp40dx4m2hks 1"), std::runtime_error);
...
BOOST_AUTO_TEST_CASE(rpc_wallet_sapling_importkey_paymentaddress)
{
    ...
    // Same spending-key payload as the historical PIVX vector, re-encoded under
    // BATHRON's MAIN HRP for the Sapling extended spending key
    // (SAPLING_EXTENDED_SPEND_KEY = "b-secret-spending-key-main", chainparams.cpp).
    // Only the human-readable prefix and bech32 checksum change; the key bytes are
    // identical, so DecodeSpendingKey accepts it under the active MAIN params.
    testAddress("b-secret-spending-key-main1qv09u0wlqqqqpqp75kpmat6l3ce29k"
                ...
                "0zweu7stxkwhp593p6drheps9uhz9pvkrfgvpxzte8d60uzw0qxadnsj4mg5q");
...
BOOST_AUTO_TEST_CASE(rpc_shieldsendmany_parameters)
{
    ...
    BOOST_CHECK_THROW(CallRPC("shieldsendmany "
                              "bs1u87kylcmn28yclnx2uy0psnvuhs2xn608ukm6n2nshrpg2nzyu3n62ls8j77m9cgp40dx4m2hks []"), std::runtime_error);
...
BOOST_AUTO_TEST_CASE(rpc_listshieldunspent_parameters)
{
    ...
    BOOST_CHECK_THROW(CallRPC("listshieldunspent 1 999 false bs1u87kylcmn28yclnx2uy0psnvuhs2xn608ukm6n2nshrpg2nzyu3n62ls8j77m9cgp40dx4m2hks"), std::runtime_error);
    ...
    // allow watch only
    BOOST_CHECK_NO_THROW(CallRPC("listshieldunspent 1 999 true [\"bs1u87kylcmn28yclnx2uy0psnvuhs2xn608ukm6n2nshrpg2nzyu3n62ls8j77m9cgp40dx4m2hks\"]"));
