...
// Copyright (c) 2021 The BATHRON Core developers
...
void test_one_input(std::vector<uint8_t> buffer)
{
    ...
    CheckTransactionAllFlagsDisabled(tx, state);
...
bool CheckTransactionWrapper(const CTransaction& tx, CValidationState state) {
