...
#ifndef BATHRON_TEST_TEST_BATHRON_H
#define BATHRON_TEST_TEST_BATHRON_H
...
// Helper to re-finalize a modified block (recompute merkle root + re-sign).
...
#endif // BATHRON_TEST_TEST_BATHRON_H
