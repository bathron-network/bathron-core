...
#ifndef BATHRON_WALLET_WALLETDB_H
#define BATHRON_WALLET_WALLETDB_H
 ...
 *
 * BATHRON: Berkeley DB has been completely removed and replaced with SQLite.
 * This is a genesis chain - no legacy compatibility needed.
 */
...
/** BATHRON: Wallet uses SQLite database (Berkeley DB removed) */
using WalletDatabase = SQLiteDatabase;
...
//! Compacts SQLite state so that wallet.dat is self-contained (if there are changes)
void MaybeCompactWalletDB();

#endif // BATHRON_WALLET_WALLETDB_H
