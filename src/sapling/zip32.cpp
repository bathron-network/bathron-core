...
const unsigned char BATHRON_HD_SEED_FP_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
    {'P', 'I', 'V', 'X', '_', '_', 'H', 'D', '_', 'S', 'e', 'e', 'd', '_', 'F', 'P'};

const unsigned char BATHRON_TADDR_OVK_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
