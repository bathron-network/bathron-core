...
#ifndef BATHRON_SAPLING_SAPLING_OPERATION_H
#define BATHRON_SAPLING_SAPLING_OPERATION_H
...
public:
    ...
    SaplingOperation* setSelectTransparentCoins(const bool select);
...
#endif // BATHRON_SAPLING_SAPLING_OPERATION_H
