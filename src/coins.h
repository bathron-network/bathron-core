...
#ifndef BATHRON_COINS_H
#define BATHRON_COINS_H
...
public:
    ...
    /**
     * Amount of bathron coming in to a transaction
...
// check=false: assumes no overwrites (BIP34 in effect)
// check=true: queries view to detect overwrites
void AddCoins(CCoinsViewCache& cache, const CTransaction& tx, int nHeight, bool check = false);

//! Utility function to find any unspent output with a given txid.
const Coin& AccessByTxid(const CCoinsViewCache& cache, const uint256& txid);

#endif // BATHRON_COINS_H
