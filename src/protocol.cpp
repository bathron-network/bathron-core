...
const static std::string allNetMessageTypes[] = {
    ...
    NetMsgType::MNAUTH, // --- tiertwoNetMessageTypes start here ---
    NetMsgType::HUSIG,
};
const static std::vector<std::string> allNetMessageTypesVec(allNetMessageTypes, allNetMessageTypes + ARRAYLEN(allNetMessageTypes));
const static std::vector<std::string> tiertwoNetMessageTypesVec(std::find(allNetMessageTypesVec.begin(), allNetMessageTypesVec.end(), NetMsgType::MNAUTH), allNetMessageTypesVec.end());
