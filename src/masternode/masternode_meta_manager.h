...
#ifndef BATHRON_TIERTWO_MASTERNODE_META_MANAGER_H
#define BATHRON_TIERTWO_MASTERNODE_META_MANAGER_H
...
private:
    mutable Mutex cs;
    uint256 proTxHash;
    // Timestamp of the last successful MNAUTH handshake with this MN
...
public:
    ...
    SERIALIZE_METHODS(CMasternodeMetaInfo, obj) {
        READWRITE(obj.proTxHash, obj.lastOutboundSuccess);
    }
...
#endif // BATHRON_TIERTWO_MASTERNODE_META_MANAGER_H
