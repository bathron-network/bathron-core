...
#ifndef BATHRON_POLICY_POLICY_H
#define BATHRON_POLICY_POLICY_H
...
static const unsigned int DUST_RELAY_TX_FEE = 200;  // 200 sat/kB → dust threshold ~36 M0 (Genesis Fee Policy v1.0)
