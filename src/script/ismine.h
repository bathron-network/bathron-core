...
#ifndef BATHRON_SCRIPT_ISMINE_H
#define BATHRON_SCRIPT_ISMINE_H
...
enum isminetype {
    ...
    ISMINE_SPENDABLE_TRANSPARENT = ISMINE_SPENDABLE,
    ISMINE_SPENDABLE_ALL = ISMINE_SPENDABLE | ISMINE_SPENDABLE_SHIELDED,
    ISMINE_WATCH_ONLY_ALL = ISMINE_WATCH_ONLY | ISMINE_WATCH_ONLY_SHIELDED,
    ISMINE_ALL = ISMINE_WATCH_ONLY | ISMINE_SPENDABLE | ISMINE_SPENDABLE_SHIELDED | ISMINE_WATCH_ONLY_SHIELDED,
