...
#ifndef BATHRON_SCRIPT_STANDARD_H
#define BATHRON_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a BATHRON address
 */
...
/**
 * Generate a BATHRON scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BATHRON_SCRIPT_STANDARD_H
