...
#ifndef BATHRON_UNDO_H
#define BATHRON_UNDO_H
 ...
 *  (coinbase or not, height). The serialization contains a dummy value
 *  of zero for compatibility.
 */
