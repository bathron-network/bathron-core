...
# Copyright (c) 2018-2023 The BATHRON Core developers
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BATHRON Core developers'
...
UPDATE_USAGE = """
Updates all the copyright headers of "The BATHRON Core developers" which were
changed in a year more recent than is listed. For example:

// Copyright (c) <firstYear>-<lastYear> The BATHRON Core developers

will be updated to:

// Copyright (c) <firstYear>-<lastModifiedYear> The BATHRON Core developers

where <lastModifiedYear> is obtained from the 'git log' history.

This subcommand also handles copyright headers that have only a single year. In those cases:

// Copyright (c) <year> The BATHRON Core developers

will be updated to:

// Copyright (c) <year>-<lastModifiedYear> The BATHRON Core developers
...
Arguments:
    <base_directory> - The base directory of a bathron source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The BATHRON Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The BATHRON Core developers'
                 % (filename))
...
INSERT_USAGE = """
Inserts a copyright header for "The BATHRON Core developers" at the top of the
...
If the file already has a copyright for "The BATHRON Core developers", the
script will exit.
